...
The Web User Interface features a limited version of the logger functionality outlined above. Working requires TRACKER_STORE_URL .env variable value to match the tracker store url used in the Rasa `endpoints.yml` file.
